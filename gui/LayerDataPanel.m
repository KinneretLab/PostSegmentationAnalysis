classdef LayerDataPanel<handle
    ...
    methods
        ...
        function showMarkerLayerPanel(obj)
            ...
            obj.ColorbarCheckBox.Parent=obj.grid_;
            obj.ColorbarCheckBox.Layout.Row = 2;
            obj.ColorbarCheckBox.Layout.Column = 2;
            ...
            obj.LineWidthSpinnerLabel.Layout.Row=9;
        ...
        function createSharedLayerData(obj)
            ...
            obj.ColorbarCheckBox.Text = 'Colorbar for Layer';
        ...
        function setClass(obj, layer_data)
            obj.Type.Text = layer_data.getClass;
        end
        ...
        function setQuiverLayerSettings(obj, layer_data)
            ...
            obj.LineWidthSpinner.Value=layer_data.getLineWidth();
        end
        ...
        function layer_data= getMarkerLayerSettings(obj, layer_data)
            ...
            layer_data.setMarkersShape(obj.ShapeDropDown.Value);
            layer_data.setLineWidth(obj.LineWidthSpinner.Value);
